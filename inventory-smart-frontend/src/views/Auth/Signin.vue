  ...
  <FullScreenLayout>
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
      <div class="relative flex lg:flex-row w-full h-screen justify-center flex-col dark:bg-gray-900">
                ...
                <form @submit="onSubmit">
                  <div class="space-y-5">
                    ...
                    <div>
                      ...
                      <p v-if="emailError" class="mt-1.5 text-sm text-error-500">
                        {{ emailError }}
                      </p>
                    ...
                    <div>
                      ...
                      <div class="relative">
                        ...
                        <p v-if="passwordError" class="mt-1.5 text-sm text-error-500">
                          {{ passwordError }}
                        </p>
                    ...
                    <div>
                      ...
                      <button type="submit" 
                        class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600 disabled:cursor-not-allowed disabled:opacity-100">
        ...
        <div class="lg:w-1/2 w-full h-full hidden lg:block relative overflow-hidden bg-brand-950">
          <img src="/images/logo/signin.png" alt="Smart Inventory" class="signin-img-right" />
        </div>
